...
public class StatsResponse {
    ...
    public long getUrlsUp() { return urlsUp; }
    public long getUrlsDown() { return urlsDown; }

    public void setTotalUrls(long totalUrls) { this.totalUrls = totalUrls; }
    public void setUrlsUp(long urlsUp) { this.urlsUp = urlsUp; }
    public void setUrlsDown(long urlsDown) { this.urlsDown = urlsDown; }
}
